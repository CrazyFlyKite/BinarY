...
from utilities import QuizFrame, generate_question_base2, RED, GREEN


class Base2Frame(QuizFrame):
	def __init__(self, root: Tk, frame: Frame, min_value_variable: StringVar, max_value_variable) -> None:
		...
		self.current_question = generate_question_base2(1, 100)
	...
	def reset(self) -> None:
		...
		self.current_question = generate_question_base2(self.min_value, self.max_value)
